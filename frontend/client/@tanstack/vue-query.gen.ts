...
export const getLawsLawsGetInfiniteQueryKey = (
  options?: Options<GetLawsLawsGetData>,
): QueryKey<Options<GetLawsLawsGetData>> => createQueryKey("getLawsLawsGet", options, true);

/**
 * Get Laws
 */
export const getLawsLawsGetInfiniteOptions = (options?: Options<GetLawsLawsGetData>) => {
  return infiniteQueryOptions<
    GetLawsLawsGetResponse,
    GetLawsLawsGetError,
    InfiniteData<GetLawsLawsGetResponse>,
    QueryKey<Options<GetLawsLawsGetData>>,
    number | Pick<QueryKey<Options<GetLawsLawsGetData>>[0], "body" | "headers" | "path" | "query">
  >(
    // @ts-ignore
    {
      queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<GetLawsLawsGetData>>[0], "body" | "headers" | "path" | "query"> =
      ...
      queryKey: getLawsLawsGetInfiniteQueryKey(options),
    },
  );
};
