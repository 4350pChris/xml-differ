...
from .types import DiffStrategy, Diff

def match_paragraphs(left: etree._Element, right: etree._Element) -> Generator[tuple[tuple[int, etree._Element], tuple[int, etree._Element]]]:
...
async def diff_files(diff_strategy: DiffStrategy, left: bytes, right: bytes) -> AsyncGenerator[Diff, None]:
